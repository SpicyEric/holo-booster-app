            ...
            >
              ...
              <div className="space-y-6 pr-8">
                ...
                <p className="text-xl text-muted-foreground leading-relaxed">
                  Eloyo kombiniert Bewertungsboost, digitale Stempelkarte, SMS-Marketing und einen professionellen Löschservice für negative Bewertungen – speziell für lokale Unternehmen.
                </p>
              </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-foreground mb-4">
              Was Eloyo für dein Geschäft erledigt
            </h2>
          </motion.div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-foreground">
                Eloyo in deinem Geschäft
              </h2>
              <p className="text-lg text-muted-foreground">
                So sieht Eloyo in deinem Geschäft aus – der QR-Aufsteller macht den gesamten Prozess für deine Kunden einfach, logisch und schnell.
              </p>
            </motion.div>
            ...
            >
              <motion.img
                src={qrStandProduct}
                alt="Eloyo Aufsteller im Einsatz"
