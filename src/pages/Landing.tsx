...
const Landing = () => {
  ...
  return <div className="bg-background text-foreground min-h-screen">
      <Particles particleColors={['#8B5CF6', '#3B82F6', '#8B5CF6']} particleCount={100} particleSpread={8} speed={0.05} particleBaseSize={100} sizeRandomness={1.5} moveParticlesOnHover={true} alphaParticles={true} disableRotation={false} cameraDistance={20} />
      
      <ClassicNav items={navItems} logo={<img src={qraitLogo} alt="QRait Logo" className="h-10 w-auto" />} />
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            once: true
                ...
                {step.details && <p className="text-sm text-muted-foreground/80">{step.details}</p>}
              </motion.div>)}
          </div>
        </div>
      </section>
      ...
      <section className="relative z-10 py-20 px-4 sm:px-6 lg:px-8 bg-muted/30">
        <div className="max-w-4xl mx-auto text-center">
          ...
          duration: 0.6
            ...
            <Button onClick={() => navigate('/kontakt')} size="lg" className="bg-white text-primary hover:bg-white/90 text-lg px-8 py-6">
              Kontakt aufnehmen
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            ...
            <div className="flex flex-wrap justify-center gap-6 text-sm">
              ...
              <a href="https://instagram.com/qrait.de" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-foreground transition-colors">
                Instagram
              </a>
            </div>
          </div>
