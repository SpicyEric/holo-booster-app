  ...
  return (
    ...
    >
      <motion.h2
        ...
        className="text-foreground text-3xl font-bold mb-20 text-center"
      >
        {title || (
          <span>
  ...
  return (
    <div className="h-full rounded-md bg-[#050505] mx-1 p-1">
      ...
      <Row>
        ...
        <KBtn>
          <div className="h-4 w-4 rounded-full bg-gradient-to-b from-neutral-900 from-20% via-black via-50% to-neutral-900 to-95% p-[0.5px]">
