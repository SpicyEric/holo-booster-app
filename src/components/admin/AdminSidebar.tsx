...
import {
  ...
  ShoppingCart, Settings, LogOut, ChevronLeft, Menu, X, Map, GitBranch, Search, Lightbulb, CalendarDays, UserPlus,
} from "lucide-react";
                ...
                return (
                  <button
                    ...
                    className={cn(
                      ...
                      active
                        ? "bg-white/15 text-white shadow-[0_2px_12px_rgba(139,92,246,0.25)] backdrop-blur-sm"
...
export default function AdminSidebar() {
    ...
    return (
      <>
        ...
        <Sheet open={mobileOpen} onOpenChange={setMobileOpen}>
          <SheetContent side="left" className="w-[280px] p-0 flex flex-col bg-[hsl(262,50%,18%)]/90 backdrop-blur-xl border-white/10">
  ...
  return (
    <aside
      className={cn(
        "sticky top-0 h-screen flex flex-col border-r border-white/10 bg-[hsl(262,50%,18%)]/85 backdrop-blur-xl transition-all duration-300 z-20 shrink-0",
