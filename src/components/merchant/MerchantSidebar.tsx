...
export default function MerchantSidebar() {
    ...
    return (
      <>
        ...
        <Sheet open={mobileOpen} onOpenChange={setMobileOpen}>
          <SheetContent side="left" className="w-[280px] p-0 flex flex-col bg-[hsl(220,13%,18%)]/95 backdrop-blur-xl border-white/10">
  ...
  return (
    <aside
      className={cn(
        "sticky top-0 h-screen flex flex-col border-r border-white/5 bg-[hsl(220,13%,18%)]/95 backdrop-blur-xl transition-all duration-300 z-20 shrink-0",
