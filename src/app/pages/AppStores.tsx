                ...
                return (
                  ...
                  >
                    ...
                    >
                      ...
                      <div className="absolute top-3 left-3 z-20 rounded-full overflow-hidden border-0 ring-0 outline-none" style={{ width: '52px', height: '52px', margin: '-2px' }}>
                        {store.logo_url ? (
                          <img src={store.logo_url} alt={`${store.name} Logo`} className="w-full h-full object-cover scale-110" />
                        ) : (
