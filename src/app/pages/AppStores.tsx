                ...
                return (
                  ...
                  >
                    ...
                    >
                      ...
                      <div className="absolute top-3 left-3 z-20 w-12 h-12 overflow-hidden border-0 ring-0 outline-none" style={{ clipPath: 'circle(50%)' }}>
                        {store.logo_url ? (
                          <img src={store.logo_url} alt={`${store.name} Logo`} className="w-full h-full object-cover scale-125" />
                        ) : (
