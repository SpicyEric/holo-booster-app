...
export const AppRewards = () => {
  ...
  const loadRewards = async () => {
    ...
    try {
      ...
      // Load user's points per merchant
      ...
      if (!pointsError && pointsData) {
        ...
        pointsData.forEach((p: UserPoints) => {
          pointsMap.set(p.merchant_customer_id, p.current_points);
        });
  ...
  if (loading) {
    return (
      <div className="p-4 space-y-4">
        <h1 className="text-2xl font-bold">Prämien</h1>
        {[1, 2, 3].map((i) => (
  ...
  return (
    <div className="p-4 space-y-6">
      <h1 className="text-2xl font-bold">Verfügbare Prämien</h1>
