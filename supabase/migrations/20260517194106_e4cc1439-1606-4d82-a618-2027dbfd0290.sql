...
BEGIN
  ...
  -- V2 Tageslimit: 1 Check-in pro Tag pro Merchant.
  -- Ausnahme: Backstube König – dort beliebig oft pro Tag erlaubt.
  IF v_is_v2_merchant AND v_merchant_customer_id <> c_backstube_id THEN
