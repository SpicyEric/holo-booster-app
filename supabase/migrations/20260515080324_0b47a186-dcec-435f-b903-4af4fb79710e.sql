-- 1) Fix award_points_via_nfc: use scalar variables instead of accessing
--    fields on an unassigned record (which raised
--    "record v_welcome_reward is not assigned yet").
...
-- 2) Track phone-change timestamp for 90-day cooldown
